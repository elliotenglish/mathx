...
def hexagon_to_tetrahedron_arr(vidxs):
  ...
  TODO: This will not yield a valid mesh in general as neighboring hexahedra need to have tetrahedra generated independently in order to have matching face tesselation. This will likely require incremental construction in order to achieve a consistent tesselation. A bunnyclipping approach is likely sufficient for convex hexahedra.
  """
